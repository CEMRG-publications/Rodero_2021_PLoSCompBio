...
def run(args, job):
    ...
    # Generate mesh
    if int(args.current_case) > 9:
      meshdir  = '/home/crg17/Desktop/Seg3DProjects/healthy_CT_MRI/h_case' + args.current_case + '/meshing/1000um/BiV'
    else:
      meshdir  = '/home/crg17/Desktop/Seg3DProjects/healthy_CT_MRI/h_case0' + str(int(args.current_case)) + '/meshing/1000um/BiV'
...
def setupStimuli(experiment,meshdir):
    ...
    if experiment=='apba':
      filename_ground = 'BiV.apex'
      filename_pot = 'BiV.base.surf'
    elif experiment=='epi':
